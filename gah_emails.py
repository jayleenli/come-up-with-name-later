...
def main():
	...
	# Tried to optimize and find emails that match specific queries, so might not be perfect and miss some.
	...
	if 'messages' in response:
		...
		# But headers vary from different senders, so we are need to guess this, so there is a high chance of error.
		# The goal is to try to reduce this error as much as possible.
		...
		for msg_info in messages_curr_page:
			...
			# Decided after research that the fields return the best results.
		...
		# Go through every page in the query until none left. 
		while 'nextPageToken' in response:
			...
			# I know code is pasted again, definitely some room for improvement in the future.
			messages_curr_page = response['messages']
